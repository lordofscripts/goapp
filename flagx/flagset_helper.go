 ...
 * standard flag package. Moved here from goVault.
 *-----------------------------------------------------------------*/
package flagx
...
// the subcommand, returning nil or an error if any. After this, upon
// successful completion, use ChosenCommandName() to obtain the sub-command
// given in the command-line, and ChosenCommand() to get the flag.FlagSet
