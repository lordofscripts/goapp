 ...
 *							goApp:mtag
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 * GO reflection to retrieve calling code's location information.
 * This was moved here from this module's `mlog` package.
 *-----------------------------------------------------------------*/
package mtag
 ...
 *-----------------------------------------------------------------*/
const (
	FRAMENR_THIS   FrameNr = 1 // from your PRESENT location
	FRAMENR_CALLER FrameNr = 2 // the CALLER of your present location
	FRAMENR_PARENT FrameNr = 3 // the parent of the caller of present location
)
...
func RetrieveCallerInfo(frame FrameNr) *CallerInfo {
	...
	pc, fileName, lineNo, ok := runtime.Caller(frame) // 0 = RetrieveCallerInfo's stack frame
